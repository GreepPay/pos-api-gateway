...
final class AuthMutation
{
    ...
    public function uploadFile($request, $resizeImg = true)
    {
        ...
        if (!in_array($contentType, $allowedMimeTypes)) {
            $photo = Storage::disk('azure')->putFile('main', $request->file('attachment'), 'public');
        } else {
            ...
            $image = Image::make($request->file('attachment'))->encode('jpeg', 60);
            ...
            $photo = Storage::disk('azure')->put('main/' . $fileName, $image->__toString(), 'public');
